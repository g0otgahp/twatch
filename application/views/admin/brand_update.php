<div class="col-sm-9">
  <div class="panel panel-success">
    ...
    <?php echo form_open('admin/brand/brand_process_update','class="form form-horizontal"'); ?>
    ...
    <div class="container" style="padding:15px;">
      ...
      <div class="form-group">
        ...
        <div class="col-md-3">
          ...
          <input required class="form-control" type="text" name="brand_name" placeholder="กรอกชื่อยี่ห้อ" value="<?php echo $brand[0]['brand_name']?>">
        </div>
      </div>
