<div class="col-sm-9">
  <div class="panel panel-success">
    <div class="panel-heading">การจัดการใบสั่งซื้อ</div>
        ...
        <table class="table table-hover" id="table">
          ...
          <?php $i=1; foreach ($order_detail as $row): ?>
            <tr>
              ...
              <?php endif; ?>
              <td align="center">
                <a href="<?php echo SITE_URL('admin/order/detail/'.$row['order_detail_id'])?>" class="btn btn-primary btn-sm">รายละเอียด</a>
              </td>
            </tr>
          <?php $i++; endforeach; ?>
          </tbody>
